...
public class MakeMyTripSearchOfFlight {
    WebDriver driver;
    WebDriverWait wait;
    ...
    public void testRoundTripFlightSearch() throws InterruptedException {
        ...
        Assert.assertTrue(bodyText.contains("200-OK"));
    }
